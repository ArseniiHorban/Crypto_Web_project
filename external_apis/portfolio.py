...
class Portfolio:
    ...
    def analyze(self):
        ...
        annual_volatility = float(self.calculate_volatility(portfolio_value_df))
        portfolio_value_df = self.calculate_daily_returns(portfolio_value_df)
        monthly_returns_df = self.calculate_monthly_returns(portfolio_value_df).dropna()
